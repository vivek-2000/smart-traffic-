...
inputFile = loc+'/inputs/625_201709141107.mp4'
        ...
        for vehicle in self.vehicles:
            if not vehicle.counted and (((vehicle.last_position[1] > self.divider) and (vehicle.vehicle_dir == 1)) or
                ...
                if ((vehicle.last_position[1] > self.divider) and (vehicle.vehicle_dir == 1) and (vehicle.last_position[0] >= (int(frame_w/2)-10))):
                    ...
                    self.vehicle_LHS += 1
                    self.vehicle_count += 1
                VehicleCounter.vehicle_LHS=self.vehicle_LHS
                VehicleCounter.vehicle_G=self.vehicle_LHS
                VehicleCounter.vehicle_RHS=self.vehicle_RHS
...
print("vehicles on left hand lane ="+str(VehicleCounter.vehicle_G))
print("Vehicles on right hand lane ="+str(VehicleCounter.vehicle_RHS))
t=VehicleCounter.vehicle_RHS
